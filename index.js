...
var drawPlaneShader = glShader(gl,
    glslify('./shaders/bunny.vert')
  , glslify('./shaders/bunny.frag')
)

var sketchShader = glShader(gl,
...
gl.canvas.addEventListener('click', function handleMouseClick(ev) {
  ...
  if (mouse3) {
    ...
    console.log(sketch)
    updateSketchGeometry(sketch.positions[sketch.positions.length - 1], mouse3)
  }
}, true);
